...
object BaseConfig {
    ...
    const val GIST_DATA_LINK =
        "https://kyc.freedomtool.org/integrations/identity-provider-service/v1/gist-data"

    const val CLAIM_OFFER_LINK_V2 = "https://issuerapi.freedomtool.org/v1/offer/{claim_id}"

    const val SEND_REGISTRATION_LINK =
        "https://proofverification.freedomtool.org/integrations/proof-verification-relayer/v1/register"
